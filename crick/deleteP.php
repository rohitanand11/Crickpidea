...
<div class="main-indents">
  <div class="main">
   ...
   <h2 id="enterplayerdetails" >Enter Player To be Deleted</h2>
   <form id="add" action="delete-submit.php" method="POST">
<div id="container" style="float:left;height:auto;width:100%;">

   
    <label class="labeladd" for="Tname">Player ID</label><br>
    <input type="text" id="Tid" name="playerid" ><br>
