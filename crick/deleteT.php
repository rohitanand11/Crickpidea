...
<div class="main-indents">
  <div class="main">
    ...
    <header>
      ...
      <nav>
         <ul class="sf-menu">
		  ...
		  <li class="current"> <a>Tournaments</a>
            <ul>
   ...
   <h2 id="enterplayerdetails" >Enter Tournament To Be Deleted</h2>
   <form id="add" action="">
<div id="container" style="float:left;height:auto;width:100%;">

   
    <label class="labeladd" for="Tname">Tournament ID</label><br>
    <input type="text" id="Tid" name="firstname" ><br>
	<label class="labeladd" for="pname">Tournamrnt Name</label><br>
	 <input type="text" id="Tname" name="firstname" ><br>
</div> 
